...
export function Card({
  ...
  return (
    <div className="p-6 aspect-square border-2 border-neutral-200 flex flex-col justify-between hover:bg-neutral-100">
      <h2 className="text-2xl font-semibold text-center">{title}</h2>
      <div className="mx-auto w-fit p-12 bg-slate-300 rounded-full">
        {getAudioTypeIcon({ type, className: "h-8 w-8" })}
      </div>
      <div className="flex items-center gap-6">
        ...
        <button
          className={cn(
            "p-3 w-fit disabled:text-neutral-500",
